...
func NewFunctionCallFrame(toolCallID, functionName, arguments string, index int) *FunctionCallFrame {
...
func (f *FunctionCallFrame) String() string {
	return fmt.Sprintf("%s(function_name: %s, tool_call_id: %s, arguments: %s index: %d type: %s)",
		f.DataFrame.Name(), f.FunctionName, f.ToolCallID, f.Arguments, f.Index, f.Type)
}

// ArgumentsDict returns the arguments as a map
func (f *FunctionCallFrame) ArgumentsDict() (map[string]interface{}, error) {
